...
class FilmApp extends HTMLElement{
  ...
  closeRatings(){if(this.active){this.saveRatings();localStorage.removeItem(this.draftKey());localStorage.removeItem('filmkvall_active_meta');}this.active=null;this.dashboard();this.status('Klart · databasen synkas i bakgrunden.');}
}
